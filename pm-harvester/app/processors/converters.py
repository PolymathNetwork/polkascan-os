        ...
        if runtime:
            ...
            try:
                ...
                for module_index, module in enumerate(self.substrate.metadata_decoder.metadata.modules):
                    ...
                    # Fixed incorrect module index when metadata version > 12
                    # https://github.com/polkascan/polkascan-pre-harvester/commit/bf6991585fd61ba8cc25c558dbd278b4ea2ac8f5
